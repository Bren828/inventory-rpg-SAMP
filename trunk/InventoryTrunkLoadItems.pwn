stock InventoryTrunkLoadItems(playerid)
{
	new string[5],
		Float:PosX = 31.0, 
		Float:PosY = 149.0, 
	...
	{
		ItemID  = 0 + (page * INV_MAX_TRUNK_SLOTS);
		ItemQty = 0 + (page * INV_MAX_TRUNK_SLOTS);
		...
		PlayerTextDrawBackgroundColor(playerid, PlayerInvTD[playerid][tiTrunk_Slot_Fon][x], InventoryColors[PlayerInvData[playerid][pid_Theme]][icColor_Slot_Fon_MarginBox]);
		...
		PlayerTextDrawBackgroundColor(playerid, PlayerInvTD[playerid][tiTrunk_Slot_Icon][x], InventoryColors[PlayerInvData[playerid][pid_Theme]][icColor_Slot_Fon_BorderBox]);
		...
		if(ItemID != 0 && ItemQty != 0)
		{
			...
			PlayerTextDrawColor(playerid, PlayerInvTD[playerid][tiTrunk_Slot_Quantity][x], InventoryColors[PlayerInvData[playerid][pid_Theme]][icColor_Text]);
